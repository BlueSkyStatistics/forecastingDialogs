...
var localization = {
    en: {
        ...
        navigation: "Holt Winters, seasonal",
        ...
        help: {
            ...
            body: `
            <b>Description</b></br>
A wrapper function for HoltWinters from package stats.<br/>
Computes Holt-Winters Filtering of a given time series. Unknown parameters are determined by minimizing the squared prediction error. Internally calls HoltWinters with  seasonal component set to "additive" or "multiplicative".<br/> 
<br/>
<b>Usage</b>
<br/>
<code> 
BSkyHoltWintersSeasonal(vars,start,frequency,exponential=FALSE,seasonal ="add",main ,ylab,plotSeries=TRUE,saveFitted=FALSE,plotOriginalandForecast=FALSE,predict=FALSE,savePredictedVals=FALSE,plotPredictedValues=FALSE,correlogram=FALSE,Ljung_Boxtest=FALSE,dataset="Dataset2")
</code> <br/>
Arguments
<ul>
<li>
...
<li>
seasonal: Character string to select an "additive" (the default) or "multiplicative" seasonal model. The first few characters are sufficient e.g. "add" or "mult".
</li>
<li>
...
forecast</br>
<b>Help</b></br>
For detailed help click on the R icon on the top right hand side of this dialog overlay or run the following command help(tidy, package ='broom') by creating a R code chunk by clicking + in the output window
			`}
    }
}
...
`
        ...
        var objects = {
            ...
            additive: { el: new radioButton(config, { label: localization.en.additive, no: "groupbox1", increment: "additive", value: "add", state: "checked", extraction: "ValueAsIs" }) },
            multiplicative: { el: new radioButton(config, { label: localization.en.multiplicative, no: "groupbox1", increment: "multiplicative", value: "mult", state: "", extraction: "ValueAsIs" }) },
...
module.exports.item = new holtWintersSeasonal().render()